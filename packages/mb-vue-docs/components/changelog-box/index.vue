<template>
  ...
  >
      ...
      <Grid :cols="5" :col-gap="20">
        ...
        <GridItem :span="2">
          <Select v-model="type" multiple :max-tag-count="2">
            ...
            <Option value="typescript" :tag-props="{ color: 'mbblue' }">
    ...
    <div class="changelog-box-content">
      <Timeline v-if="filterChangelog.length > 0" class="mb-changelog">
...
.changelog-box {
  ...
  &-filter {
    ...
    :deep(.mb-space-item):first-of-type,
    :deep(.mb-space-item):last-of-type {
      flex: 1;
    }
  }
