const CSS_EXTERNAL = ['https://unpkg.com/@mb-design/web-vue@2.x/dist/mb.css'];
const JS_EXTERNAL = [
  'https://unpkg.com/vue@3.x/dist/vue.global.prod.js',
  'https://unpkg.com/dayjs@1.x/dayjs.min.js',
  'https://unpkg.com/@mb-design/web-vue@2.x/dist/mb-vue.min.js',
  'https://unpkg.com/@mb-design/web-vue@2.x/dist/mb-vue-icon.min.js',
];
...
const parseContent = (content: string) => {
    ...
    .replace(/import (.*?) from '(.*?)'/gs, (match, p1, p2) => {
      switch (p2) {
        case 'vue':
          p2 = 'window.Vue';
          break;
        case '@mb-design/web-vue':
          p2 = 'window.MbVue';
          break;
        case '@mb-design/web-vue/es/icon':
          p2 = 'window.MbVueIcon';
          break;
        default:
      }
  ...
  }\nconst app = Vue.createApp(Main);\napp.use(window.MbVue);\napp.use(window.MbVueIcon);\napp.mount('#root');`;
