...
- **tree-select:** 默认支持通过标签删除已选项 ([#1206](https://github.com/mb-design/mb-design-vue/pull/1206))
...
- **table:** 修复开启排序后，表头文字不能居中的问题 ([#845](https://github.com/mb-design/mb-design-vue/pull/845))
...
- **transfer:** 修复列表显示问题 ([#744](https://github.com/mb-design/mb-design-vue/pull/744))
...
- **image:** 新增 actions 插槽用于自定义预览的操作项 ([#679](https://github.com/mb-design/mb-design-vue/pull/679))
...
- **steps:** 修复 dot 模式下可以开启 small 的问题 ([#536](https://github.com/mb-design/mb-design-vue/pull/536))
...
- **tree-select:** 修复设置 key 字段名的时候搜索失效的问题 ([#405](https://github.com/mb-design/mb-design-vue/pull/405))
...
- **link:** 增加通过 `icon` 属性/插槽设置图标 ([#226](https://github.com/mb-design/mb-design-vue/pull/226))
...
- **spin:** 增加 `size` 属性和 `#icon` & `#element` 插槽 ([#86](https://github.com/mb-design/mb-design-vue/pull/86))
- **image:** 增加一个名为 `error-icon` 的 slot 用于支持定制错误状态的图标 ([#85](https://github.com/mb-design/mb-design-vue/pull/85))
- 增加 `日文` 支持 ([#13](https://github.com/mb-design/mb-design-vue/pull/13))

### 🐛 问题修复

- **slider:** 修复点击右键没有释放拖拽事件的问题 ([#97](https://github.com/mb-design/mb-design-vue/pull/97))
- **select:** 修复 `#empty` 插槽丢失的问题 ([#96](https://github.com/mb-design/mb-design-vue/pull/96))
- **input-number:** 修复精度失效的问题 ([#93](https://github.com/mb-design/mb-design-vue/pull/93))
- **input-tag:** 修复输入框宽度计算错误的问题 ([#89](https://github.com/mb-design/mb-design-vue/pull/89))
- **input:** 移除 `keydown` 事件的阻止默认行为 ([#84](https://github.com/mb-design/mb-design-vue/pull/84))
- **table:** 修复 `#column` 插槽不能支持Fragment的问题 ([#83](https://github.com/mb-design/mb-design-vue/pull/83))
- **table:** 修复 `scroll.x` 单独使用不生效的问题 ([#83](https://github.com/mb-design/mb-design-vue/pull/83))
- **textarea:** 修复自动高度调整不准的问题 ([#78](https://github.com/mb-design/mb-design-vue/pull/78))
- **input:** 修复 `a-input-number` 组件 `model-value` 默认值为 0 时不生效的问题 ([#75](https://github.com/mb-design/mb-design-vue/pull/75))
- **input:** 修复 `input-search` 和 `input-password` 不支持 `slot` 的问题 ([#63](https://github.com/mb-design/mb-design-vue/pull/63))
- **input:** 修复 `input-password` 切换密码可见状态时光标位置丢失的问题 ([#63](https://github.com/mb-design/mb-design-vue/pull/63))

### 💅 样式更新

- **input:** 修改 `clear-btn` 样式，解决 `select-view` 可能会抖动的问题 ([#70](https://github.com/mb-design/mb-design-vue/pull/70))
...
- **select:** 修复清除按钮在多选模式下不显示的问题 ([#38](https://github.com/mb-design/mb-design-vue/pull/38))
- **modal:** 修复主按钮类型错误的问题 ([#30](https://github.com/mb-design/mb-design-vue/pull/30))
- **drawer:** 修复主按钮类型错误的问题 ([#30](https://github.com/mb-design/mb-design-vue/pull/30))
- **table:** 修复 `scroll` 模式下，滚动条的显隐导致单元格错位 ([#29](https://github.com/mb-design/mb-design-vue/pull/29))
