...
describe('Avatar', () => {
  test('Should have prefix', () => {
    ...
    expect(wrapper.classes()).toContain('mb-avatar');
  });
  ...
  test('Size should work', () => {
    ...
    const avatar = wrapper.find('.mb-avatar');
  ...
  test('Trigger-type should work', async () => {
    ...
    let triggerElement = wrapper.find('.mb-avatar-trigger-icon-mask');
    expect(triggerElement.exists()).toBe(true);
    await wrapper.setProps({ triggerType: 'button' });
    triggerElement = wrapper.find('.mb-avatar-trigger-icon-button');
    expect(triggerElement.exists()).toBe(true);
  });
  ...
  test('Avatar group should work', () => {
    ...
    expect(group.classes()).toContain('mb-avatar-group');
    const avatars = group.findAll('.mb-avatar');
