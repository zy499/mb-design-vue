...
.menu-demo .mb-menu :deep(.mb-menu-collapse-button) {
  width: 32px;
  height: 32px;
  border-radius: 50%;
}

.menu-demo .mb-menu:not(.mb-menu-collapsed) :deep(.mb-menu-collapse-button) {
  right: 0;
  bottom: 8px;
  transform: translateX(50%);
}

.menu-demo .mb-menu:not(.mb-menu-collapsed)::before {
  content: '';
  position: absolute;
  right: 0;
  bottom: 0;
...
.menu-demo .mb-menu.mb-menu-collapsed {
  width: 48px;
  height: auto;
  padding-top: 24px;
...
.menu-demo .mb-menu.mb-menu-collapsed :deep(.mb-menu-collapse-button) {
  right: 8px;
  bottom: 8px;
}
</style>
