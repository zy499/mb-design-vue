...
describe('Badge', () => {
  test('Should have prefix', () => {
    ...
    expect(wrapper.classes()).toContain('mb-badge');
  });
  ...
  test('Count should work', () => {
    ...
    const numberElement = wrapper.find('.mb-badge-number');
  ...
  test('Can set custom text', () => {
    ...
    const textElement = wrapper.find('.mb-badge-text');
