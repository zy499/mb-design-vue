...
describe('Select', () => {
  test('show dropdown correctly', async () => {
    ...
    await wrapper.find('.mb-select-view').trigger('click');
  ...
  test('keyboard correctly', async () => {
    ...
    expect(dropdown.find('.mb-select-option-active').text()).toBe('Guangzhou');

    await input.trigger('keydown', { key: 'ArrowDown' });

    expect(dropdown.find('.mb-select-option-active').text()).toBe('Beijing');
  ...
  test('should support mouse', async () => {
    ...
    await input.trigger('click');
    const dropdown = wrapper.findComponent({ name: 'SelectDropdown' });
    const options = dropdown.findAll('.mb-select-option');
  ...
  test('should show search option', async () => {
    ...
    const dropdown = wrapper.findComponent({ name: 'SelectDropdown' });
    const option = dropdown.find('.mb-select-option');
