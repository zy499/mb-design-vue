...
import IconUpload from '@mb-design/web-vue/es/icon/icon-upload';
import IconFileAudio from '@mb-design/web-vue/es/icon/icon-file-audio';
import IconClose from '@mb-design/web-vue/es/icon/icon-close';
import IconFaceFrownFill from '@mb-design/web-vue/es/icon/icon-face-frown-fill';
